...
software/gatk-4.3.0.0/gatk --java-options "-Xmx8G" HaplotypeCaller -R ref/ucsc.no_hap.hg19.fa -I 01_realign/19BY0125.bam -L ref/Design_V2.hg19.bed -ERC BP_RESOLUTION \
